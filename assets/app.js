/* Farmora — front-end interactions (no dependencies) */
(function () {
  "use strict";
  ...
  var revealSel = ".reveal, .section h2, .crop-card, .season-flow__item, .field-report, .price-card, .member-card3, .stat-cell4";
  ...
  if (pwd && meter) {
    pwd.addEventListener("input", function () {
      ...
      meter.style.background = ["", "#B42318", "#D97706", "#4CAF50", "#16794F"][score];
    });
  }
